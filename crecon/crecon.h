...
extern "C" {
    ...
    recon_status recon_wall_table_add_alias(recon_wall_table, const char*, const char*, recon_transform);
    ...
    recon_status recon_transform_create_none(recon_transform*);
    recon_status recon_transform_create_inverse(recon_transform*);
    recon_status recon_transform_create_affine(recon_transform*, double, double);
