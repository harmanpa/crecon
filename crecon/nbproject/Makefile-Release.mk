...
${OBJECTDIR}/crecon_wall_meta.o: crecon_wall_meta.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/crecon_wall_meta.o crecon_wall_meta.c

${OBJECTDIR}/crecon_wall_object.o: crecon_wall_object.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/crecon_wall_object.o crecon_wall_object.c
...
${OBJECTDIR}/crecon_wall_meta_nomain.o: ${OBJECTDIR}/crecon_wall_meta.o crecon_wall_meta.c 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/crecon_wall_meta_nomain.o crecon_wall_meta.c;\
	else  \
...
${OBJECTDIR}/crecon_wall_object_nomain.o: ${OBJECTDIR}/crecon_wall_object.o crecon_wall_object.c 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/crecon_wall_object_nomain.o crecon_wall_object.c;\
	else  \
