...
${OBJECTDIR}/crecon.o: crecon.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/crecon.o crecon.c

${OBJECTDIR}/crecon_meld.o: crecon_meld.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/crecon_meld.o crecon_meld.c
...
${OBJECTDIR}/crecon_nomain.o: ${OBJECTDIR}/crecon.o crecon.c 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.c) -g -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/crecon_nomain.o crecon.c;\
	else  \
...
${OBJECTDIR}/crecon_meld_nomain.o: ${OBJECTDIR}/crecon_meld.o crecon_meld.c 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.c) -g -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/crecon_meld_nomain.o crecon_meld.c;\
	else  \
