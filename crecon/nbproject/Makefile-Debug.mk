...
${OBJECTDIR}/bson.o: bson.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -DMONGO_HAVE_STDINT -MMD -MP -MF $@.d -o ${OBJECTDIR}/bson.o bson.c

${OBJECTDIR}/crecon.o: crecon.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -DMONGO_HAVE_STDINT -MMD -MP -MF $@.d -o ${OBJECTDIR}/crecon.o crecon.c

${OBJECTDIR}/encoding.o: encoding.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -DMONGO_HAVE_STDINT -MMD -MP -MF $@.d -o ${OBJECTDIR}/encoding.o encoding.c
