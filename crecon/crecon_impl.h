...
extern "C" {
	...
	*/
	...
	recon_status recon_wall_table_visit_signals(recon_wall_table , msgpack_object_array , int );

	recon_status recon_wall_table_visit_aliases(recon_wall_table , msgpack_object_map , int );
